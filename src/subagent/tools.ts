...
let subagentToolsRegistered = false

export function resetSubagentTools(): void {
  subagentToolsRegistered = false
}
...
export function registerSubagentTools(
  ...
  if (subagentToolsRegistered) return
